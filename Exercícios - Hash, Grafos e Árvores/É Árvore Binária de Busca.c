...
//Insira o código aqui
  ...
  //se o nó da esquerda for diferente de nulo
  //se o item do nó da esquerda for maior ou igual ao nó principal
  //return false
  if(arvore->esq != NULL && arvore->esq->item.chave >= arvore->item.chave) return false;


  //se o nó da direita for diferente de nulo
  //se o item do nó da direita for menor ou igual ao nó principal
  //return false
  if(arvore->dir != NULL && arvore->dir->item.chave <= arvore->item.chave) return false;

  //chama recursivamente passando esquerda e direita
